    ...
    <ProfileLayout>
      ...
      {confirm ? (
        <View style={{ gap: 32 }}>
          ...
          >
            Deleting your account means you won’t be able to access your
            personal vehicle permits and manage guest profiles. All your
            QuikSlip account data will be deleted.
          </Text>
          <CpButton
          ...
          <Text style={globalStyles.h8}>
            You will permanently lose all your information, profile, and access
            to invite others to park at Eric Brown Holmes. After this, there is
            no turning back.
          </Text>
        </View>
      ) : (
